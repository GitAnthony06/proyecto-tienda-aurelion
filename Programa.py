...
def fuente_definicion_estructura_tipos_escala():
    print('\n' + '-' * 75)
    print(dedent('''\
        **Fuente:**  
        clientes.xlsx  
...
def pasos_pseudocodigo_diagrama():
    print('\n' + '-' * 75)
    print(dedent('''\
...
def main():
    print('-' * 75)
    print("Bienvenido al Programa de Navegación de Contenidos del Proyecto Tienda Aurelion!")
    while True:
        print('-' * 75)
        print("Menú Principal:")
        print("1. Tema, problema y solución")
        print("2. Fuente, definición, estructura, tipos y escala.")
        print("3. Pasos, pseudocódigo y diagrama.")
        ...
        try:
            ...
            print('\nEntrada Invalida!!! Por favor, ingresar un número entre 1 y 5.\n')
            continue
        
        if choice == 1:
            tema_problema_solucion()
        elif choice == 2:
            fuente_definicion_estructura_tipos_escala()
        elif choice == 3:
            pasos_pseudocodigo_diagrama()
        elif choice == 4:
            sugerencias_mejoras()
        elif choice == 5:
            print("\nGracias por usar el Programa de Navegación de Contenidos. ¡Hasta luego!")
            break
        else:
